@extends('layouts.app')
@section('title', __('lang.objectives'))
@section('content')
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header"><h4>@lang('lang.objectives')</h4></div>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                    ...
                                                    <li>
                                                        <a data-href="{{ route('objectives.edit', $objective->objective_id) }}"
        ...
        @include('adminPanel.objectives.create')
    </div>
</div>
@endsection
