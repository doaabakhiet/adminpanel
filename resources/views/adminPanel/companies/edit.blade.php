    ...
    <div class="modal-dialog  rollIn  animated" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">@lang('lang.edit_company')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeModal()">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            {!! Form::open(['route' => ['company.update', $company->id], 'method' => 'put', 'id' => 'company-update-form', 'enctype' => 'multipart/form-data']) !!}

            {{-- <form action="{{ route('company.update',$company->id) }}" method="put" enctype="multipart/form-data"> --}}
            @csrf
            @method('PUT')
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @foreach ($company->company_translations as $key => $lang)
                ...
                <div>
                    @php
                        $image = App\Models\company::find($company->id)->getFirstMediaUrl('images');
                    @endphp

                    <img src="{{ $image }}" alt="Image for company" width="300" height="200">
                </div>
