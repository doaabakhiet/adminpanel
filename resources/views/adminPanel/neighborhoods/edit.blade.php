    ...
    <div class="modal-dialog  rollIn  animated" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">@lang('lang.edit_neighborhood')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeModal()">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            {!! Form::open([
                'route' => ['neighborhoods.update', $neighborhood->id],
                'method' => 'put',
                'id' => 'neighborhood-update-form',
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @foreach ($neighborhood->neighborhood_translations as $key => $lang)
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('city_id', $cities, $neighborhood->city_id, [
